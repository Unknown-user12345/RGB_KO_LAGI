...
static struct platform_profile_handler acer_predator_v4_pprof = {
 ...
 static int acer_platform_profile_setup(struct platform_device *pdev)
 {
     ...
     acer_predator_v4_platform_profile_probe(NULL, acer_predator_v4_pprof.choices);

     err = platform_profile_register(&acer_predator_v4_pprof);
     if (err) {
         pr_warn("Platform profile registration failed, error: %d\n", err);
         return err;
     }
